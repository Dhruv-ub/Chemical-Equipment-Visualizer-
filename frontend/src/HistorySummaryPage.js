...
function HistorySummaryPage() {
    ...
    const handleDownloadPDF = () => {
        ...
        const opt = {
            margin: [0.5, 0.5],
            filename: `history_report_${id}.pdf`,
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-200 p-8">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <button
                        onClick={() => navigate('/history')}
                        className="px-6 py-3 bg-slate-700 text-white rounded-lg hover:bg-slate-800 font-semibold transition-colors shadow-md"
                    >
                        ← Back to History
                    </button>
                    <button
                ...
                <div id="history-report-content" style={{ padding: '20px', backgroundColor: 'white' }}>
                    ...
                    {chartData.length > 0 && (
                        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                            ...
                            <div className="flex justify-center items-center" style={{ maxWidth: '600px', margin: '0 auto' }}>
